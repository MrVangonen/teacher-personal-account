        ...
        <v-card elevation="0">
          ...
          >
            <div class="d-flex flex-column align-center">
              <h1 class="font-weight-bold display-3 accent--text pb-2">
                {{ discipline.title }}
              </h1>
              <span class="mb-2">
                {{
                  discipline.existingPeriod.start.toLocaleDateString("rus", {
                    day: "numeric",
                    month: "long"
                  })
                }}
                -
                {{
                  discipline.existingPeriod.end.toLocaleDateString("rus", {
                    day: "numeric",
                    month: "long"
                  })
                }}
                  ...
                  >
                    <template v-slot:body="props">
                      <tr v-for="item in props.items">
                        ...
                        <td v-for="(lesson, index) in currentStatementLessons">
                          <MarkPicker
                            v-on:update:marks = "item[lesson.value].marks.push($event)"
                            :marks="
                              item[lesson.value] && item[lesson.value].marks
                            "
                            :onClick="changeTable"
                            :disabled="
                              item[lesson.value] &&
                                !item[lesson.value].attendance
                            "
                            readOnly
                          />
                        </td>
      ...
      allLessonsTableData: [
        {
          id: 1,
          status: 0,
          lessonDate: "18.02.2020 18:15 - 19:35",
          averageAttendance: 2,
          averageMark: 3
        },
        {
          id: 2,
          status: 1,
          lessonDate: "19.02.2020 18:15 - 19:35",
          averageAttendance: 2,
          averageMark: 3
        },
        {
          id: 3,
          status: 2,
          lessonDate: "20.02.2020 18:15 - 19:35",
          averageAttendance: 2,
          averageMark: 3
        },
        {
          id: 4,
          status: 0,
          lessonDate: "21.02.2020 18:15 - 19:35",
          averageAttendance: 2,
          averageMark: 3
        },
        {
          id: 5,
          status: 0,
          lessonDate: "22.02.2020 18:15 - 19:35",
          averageAttendance: 2,
          averageMark: 3
        }
      ]
